...
const tagFieldsStyles = tv({
    ...
    variants: {
        appearance: {
            ...
            cool: [
                "bg-black px-2.5 rounded-lg",
                "has-[input[data-focused=true]]:border-primary",
                "has-[input[data-invalid=true][data-focused=true]]:border-danger has-[input[data-invalid=true]]:border-danger has-[input[data-invalid=true]]:ring-danger/50",
                "has-[input[data-focused=true]]:ring-4 has-[input[data-focused=true]]:ring-primary/30",
            ],
        },
    },
});
